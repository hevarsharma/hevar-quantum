...
import { Cloud, Zap, CheckCircle2, Workflow } from "lucide-react";
      ...
      <div style={{ width: '100%', maxWidth: '1200px', margin: '0 auto', padding: '120px 20px 60px 20px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) minmax(0, 1fr)', gap: '60px', alignItems: 'center', marginBottom: '80px' }}>
          <div className="fadeUp">
            ...
            <p style={{ fontSize: '1.2rem', color: '#9CA3AF', lineHeight: 1.6, marginBottom: '40px' }}>
              End-to-end infrastructure deployment across cloud or on-prem environments engineered for maximum security and high availability.
            </p>
          </div>
          ...
          <div className="fadeUp" style={{ animationDelay: '0.2s', position: 'relative', borderRadius: '24px', overflow: 'hidden', border: '1px solid rgba(255, 255, 255, 0.08)', boxShadow: '0 0 40px rgba(59, 130, 246, 0.1)' }}>
            <Image
              src="/services/deployment_header_1772177158869.png"
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '30px', marginBottom: '80px' }}>
          <div className="fadeUp" style={{ animationDelay: '0.3s', background: 'rgba(255, 255, 255, 0.02)', border: '1px solid rgba(255, 255, 255, 0.05)', borderRadius: '20px', padding: '40px', backdropFilter: 'blur(10px)' }}>
            ...
            <h2 style={{ fontSize: '1.5rem', marginBottom: '16px', color: '#F8FAFC' }}>Infrastructure Challenges</h2>
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, color: '#9CA3AF' }}>
              {['Complex multi-cloud management', 'Manual, error-prone deployments', 'Vulnerabilities in infrastructure', 'Lack of disaster recovery', 'Unpredictable scaling costs'].map((item, i) => (
          ...
          <div className="fadeUp" style={{ animationDelay: '0.4s', background: 'rgba(255, 255, 255, 0.02)', border: '1px solid rgba(255, 255, 255, 0.05)', borderRadius: '20px', padding: '40px', backdropFilter: 'blur(10px)' }}>
            ...
            <p style={{ color: '#9CA3AF', lineHeight: 1.6 }}>
              We implement Infrastructure as Code (IaC) and fully automated CI/CD pipelines. This ensures every deployment is secure, repeatable, and capable of instantaneous rollback across AWS, Azure, GCP or On-Premise environments.
            </p>
          </div>
        </div>
        ...
        <div className="fadeUp" style={{ animationDelay: '0.5s', marginBottom: '80px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px' }}>
            {[
              { title: 'Terraform IaC', desc: 'Immutable infrastructure definition scripts for completely reproducible deployment states.', icon: <CheckCircle2 color="#3B82F6" size={24} /> },
              { title: 'Kubernetes Orchestration', desc: 'Containerized workloads dynamically scaled to meet real-time web traffic demands.', icon: <CheckCircle2 color="#3B82F6" size={24} /> },
              { title: 'Multi-Region Failover', desc: 'Active-active deployments distributed geographically to guarantee zero point of failure.', icon: <CheckCircle2 color="#3B82F6" size={24} /> },
              { title: 'CI/CD Pipelines', desc: 'Automated GitHub Actions compiling, testing, and shipping code straight to production clusters.', icon: <CheckCircle2 color="#3B82F6" size={24} /> },
              { title: 'Real-Time Telemetry', desc: 'Deep Datadog & Prometheus integrations for granular metrics on system load and bottlenecks.', icon: <CheckCircle2 color="#3B82F6" size={24} /> },
              { title: 'Zero-Trust Networking', desc: 'Micro-segmentation within VPCs securely isolating microservices from unauthorized access.', icon: <CheckCircle2 color="#3B82F6" size={24} /> }
            ].map((feature, i) => (
